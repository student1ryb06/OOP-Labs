...
## Завдання
Вправа з розділу "Functions" на learnpython.org.

**Умова:** Написати функцію `list_benefits()`, яка повертає список переваг функцій. Написати функцію `build_sentence(benefit)`, яка приймає один аргумент і повертає речення. Потім об'єднати їх роботу, щоб вивести на екран всі переваги у вигляді речень.
